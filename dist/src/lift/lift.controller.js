...
let LiftController = class LiftController {
    constructor(liftService, helperService, usersService) {
    ...
    async getStaticImageRoute(body) {
        try {
            const to = body.to;
            const from = body.from;
            const response = await fetch('https://maps.googleapis.com/maps/api/directions/json?origin=' + to + '&destination=' + from + '&mode=driving&key=' + configuration_1.GOOGEL_MAP_KEY + '', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
            const data = await response.json();
            const url = 'https://maps.googleapis.com/maps/api/staticmap?size=360x800&maptype=roadmap&scale=2&markers=size:mid|color:red|' + body.to + '|' + body.from + '&path=weight:2|enc%3A' + data.routes[0].overview_polyline.points + '&key=' + configuration_1.GOOGEL_MAP_KEY + '';
    ...
    async getPlaceApi() {
        const response = await fetch('https://maps.googleapis.com/maps/api/directions/json?origin=28.5355,77.3910&destination=28.9845,77.7064&sensor=true&avoid=highways&mode=driving&alternatives=true&key=' + configuration_1.GOOGEL_MAP_KEY + '', {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
    ...
    async LiftRequestFromUSer(body) {
        try {
            const data = body;
            const usre_id = body.user.id;
            delete data.user;
    ...
    async fetchUserRequest(body, roles) {
        try {
    ...
    async accepctRejectLiftRequst(body) {
        try {
    ...
    async deleteNotifications(body) {
        try {
    ...
    async getSingleVirtualLift(body) {
        try {
    ...
    async virtualLiftAcceptUser(body) {
        try {
    ...
    async virtualLiftRejectUser(body) {
        const lift_id = body['lift_request_id'];
        const notification_id = body['notification_id'];
        if (!lift_id || !notification_id) {
            return { "status": false, message: 'provide valid parameter' };
    ...
    async virtualLiftAcceptReject(body) {
        try {
...
__decorate([
    (0, common_1.Post)('create-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "create", null);
__decorate([
    (0, common_1.Post)('update-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "Update", null);
__decorate([
    (0, common_1.Get)('fetch-my-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "fetchMyLift", null);
__decorate([
    (0, common_1.Post)('search-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "SearchLift", null);
__decorate([
    (0, common_1.Get)('fetch-all'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], LiftController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('fetch-single-lift/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "findSinfetchgleLift", null);
__decorate([
    (0, common_1.Post)('update-lift-status'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)('get-route-image'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "getStaticImageRoute", null);
__decorate([
    (0, common_1.Get)('get-place-api'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "getPlaceApi", null);
__decorate([
    (0, common_1.Post)('create-lift-request'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "LiftRequestFromUSer", null);
__decorate([
    (0, common_1.Get)('get-lift-request/:role'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Param)('role')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "fetchUserRequest", null);
__decorate([
    (0, common_1.Post)('action-lift-request'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "accepctRejectLiftRequst", null);
__decorate([
    (0, common_1.Post)('my-booking'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "myBooking", null);
__decorate([
    (0, common_1.Get)('active-booking/:id'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "activeLift", null);
__decorate([
    (0, common_1.Get)('get-booking-user-info'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "getBookingUserInfo", null);
__decorate([
    (0, common_1.Post)('my-notifications'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "myNotifications", null);
__decorate([
    (0, common_1.Post)('delete-notifications'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "deleteNotifications", null);
__decorate([
    (0, common_1.Post)('create-virtual-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "createVirtualLift", null);
__decorate([
    (0, common_1.Get)('get-virtual-lift'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "getVirtualLift", null);
__decorate([
    (0, common_1.Post)('get-virtual-lift-details'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "getSingleVirtualLift", null);
__decorate([
    (0, common_1.Post)('virtual-lift-accept-user'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "virtualLiftAcceptUser", null);
__decorate([
    (0, common_1.Post)('virtual-lift-reject-user'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "virtualLiftRejectUser", null);
__decorate([
    (0, common_1.Post)('virtual-lift-accept-reject'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "virtualLiftAcceptReject", null);
__decorate([
    (0, common_1.Post)('cancle-booking'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LiftController.prototype, "cancleBooking", null);
LiftController = __decorate([
    (0, common_1.Controller)({ path: 'lift', version: '1' }),
    __metadata("design:paramtypes", [lift_service_1.LiftService,
        helper_1.HelperService,
        users_service_1.UsersService])
], LiftController);
exports.LiftController = LiftController;
//# sourceMappingURL=lift.controller.js.map